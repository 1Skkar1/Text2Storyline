...
export class FreetextComponent implements OnInit {
  ...
  public byDocOrSentence: boolean;
  ...
  toggleDocOrSentence() {
    this.byDocOrSentence = !this.byDocOrSentence;
  }
  ...
  public getKeyword(event: any) {
    ...
    this.optio = {
      ...
      docOrSentence: this.byDocOrSentence ? "doc" : "sentence",
